...
public class TechnikAktualisierenViewController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        if(App.getSelectedTechnik() instanceof Boxen){
            TabPane.getSelectionModel().select(0);
        }
        else if(App.getSelectedTechnik() instanceof Kabel){
            TabPane.getSelectionModel().select(1);
        }
        else if(App.getSelectedTechnik() instanceof Traversen){
            TabPane.getSelectionModel().select(2);
        }
        else if(App.getSelectedTechnik() instanceof Pult){
            TabPane.getSelectionModel().select(3);
        }
        else if(App.getSelectedTechnik() instanceof Buehnenplatte){
            TabPane.getSelectionModel().select(4);
        }
        else if(App.getSelectedTechnik() instanceof Monitor){
